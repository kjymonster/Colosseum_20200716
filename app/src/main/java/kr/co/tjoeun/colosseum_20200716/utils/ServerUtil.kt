...
//            urlBuilder.addEncodedQueryParameter("page_num", "1")
        ...
        fun postRequestLikeOrDisLike(context: Context, replyId: Int, isLike:Boolean, handeler: JsonResponseHandler?) {
        ...
        fun postRequestReply(context: Context, topicId : Int,content :String, handeler: JsonResponseHandler?) {
